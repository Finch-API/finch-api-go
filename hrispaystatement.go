...
type PayStatementParam struct {
	// The array of earnings objects associated with this pay statement
	Earnings param.Field[[]PayStatementEarningParam] `json:"earnings,required"`
	// The array of deductions objects associated with this pay statement.
	EmployeeDeductions    param.Field[[]PayStatementEmployeeDeductionParam]    `json:"employee_deductions,required"`
	EmployerContributions param.Field[[]PayStatementEmployerContributionParam] `json:"employer_contributions,required"`
	...
	// The payment method.
	PaymentMethod param.Field[PayStatementPaymentMethod] `json:"payment_method,required"`
	// The array of taxes objects associated with this pay statement.
	Taxes param.Field[[]PayStatementTaxParam] `json:"taxes,required"`
	// The number of hours worked for this pay period
	TotalHours param.Field[float64] `json:"total_hours,required"`
	// The type of the payment associated with the pay statement.
	Type param.Field[PayStatementType] `json:"type,required"`
}

func (r PayStatementParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEarningParam struct {
	// The earnings amount in cents.
	...
	// The type of earning.
	Type       param.Field[PayStatementEarningsType]            `json:"type,required"`
	Attributes param.Field[PayStatementEarningsAttributesParam] `json:"attributes"`
}

func (r PayStatementEarningParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEarningsAttributesParam struct {
	Metadata param.Field[PayStatementEarningsAttributesMetadataParam] `json:"metadata,required"`
}

func (r PayStatementEarningsAttributesParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEarningsAttributesMetadataParam struct {
	// The metadata to be attached to the entity by existing rules. It is a key-value
	// pairs where the values can be of any type (string, number, boolean, object,
	// array, etc.).
...
func (r PayStatementEarningsAttributesMetadataParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEmployeeDeductionParam struct {
	// The deduction amount in cents.
	Amount param.Field[int64] `json:"amount,required"`
	// The deduction currency.
	Currency param.Field[string] `json:"currency,required"`
	...
	Attributes param.Field[PayStatementEmployeeDeductionsAttributesParam] `json:"attributes"`
}

func (r PayStatementEmployeeDeductionParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEmployeeDeductionsAttributesParam struct {
	Metadata param.Field[PayStatementEmployeeDeductionsAttributesMetadataParam] `json:"metadata,required"`
}

func (r PayStatementEmployeeDeductionsAttributesParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEmployeeDeductionsAttributesMetadataParam struct {
	// The metadata to be attached to the entity by existing rules. It is a key-value
	// pairs where the values can be of any type (string, number, boolean, object,
	// array, etc.).
	Metadata param.Field[map[string]interface{}] `json:"metadata,required"`
...
func (r PayStatementEmployeeDeductionsAttributesMetadataParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEmployerContributionParam struct {
	// The contribution currency.
	Currency param.Field[string] `json:"currency,required"`
	// The contribution name from the pay statement.
	Name param.Field[string] `json:"name,required"`
	...
	Attributes param.Field[PayStatementEmployerContributionsAttributesParam] `json:"attributes"`
}

func (r PayStatementEmployerContributionParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEmployerContributionsAttributesParam struct {
	Metadata param.Field[PayStatementEmployerContributionsAttributesMetadataParam] `json:"metadata,required"`
}

func (r PayStatementEmployerContributionsAttributesParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementEmployerContributionsAttributesMetadataParam struct {
	// The metadata to be attached to the entity by existing rules. It is a key-value
	// pairs where the values can be of any type (string, number, boolean, object,
	// array, etc.).
	Metadata param.Field[map[string]interface{}] `json:"metadata,required"`
...
func (r PayStatementEmployerContributionsAttributesMetadataParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementTaxParam struct {
	// The currency code.
	Currency param.Field[string] `json:"currency,required"`
	// `true` if the amount is paid by the employers.
	...
	Name param.Field[string] `json:"name,required"`
	// The type of taxes.
	Type param.Field[PayStatementTaxesType] `json:"type,required"`
	// The tax amount in cents.
	Amount     param.Field[int64]                            `json:"amount"`
	Attributes param.Field[PayStatementTaxesAttributesParam] `json:"attributes"`
}

func (r PayStatementTaxParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementTaxesAttributesParam struct {
	Metadata param.Field[PayStatementTaxesAttributesMetadataParam] `json:"metadata,required"`
}

func (r PayStatementTaxesAttributesParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type PayStatementTaxesAttributesMetadataParam struct {
	// The metadata to be attached to the entity by existing rules. It is a key-value
	// pairs where the values can be of any type (string, number, boolean, object,
	// array, etc.).
	Metadata param.Field[map[string]interface{}] `json:"metadata,required"`
...
func (r PayStatementTaxesAttributesMetadataParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
