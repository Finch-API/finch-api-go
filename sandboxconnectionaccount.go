...
func (r SandboxConnectionAccountNewResponseAuthenticationType) IsKnown() bool {
	switch r {
	case SandboxConnectionAccountNewResponseAuthenticationTypeAPIToken, SandboxConnectionAccountNewResponseAuthenticationTypeAssisted, SandboxConnectionAccountNewResponseAuthenticationTypeCredential, SandboxConnectionAccountNewResponseAuthenticationTypeOAuth:
		return true
	}
	return false
}
...
func (r SandboxConnectionAccountUpdateResponseAuthenticationType) IsKnown() bool {
	switch r {
	case SandboxConnectionAccountUpdateResponseAuthenticationTypeAPIToken, SandboxConnectionAccountUpdateResponseAuthenticationTypeAssisted, SandboxConnectionAccountUpdateResponseAuthenticationTypeCredential, SandboxConnectionAccountUpdateResponseAuthenticationTypeOAuth:
		return true
	}
	return false
}
...
type SandboxConnectionAccountNewParams struct {
	CompanyID param.Field[string] `json:"company_id" api:"required" format:"uuid"`
...
func (r SandboxConnectionAccountNewParamsAuthenticationType) IsKnown() bool {
	switch r {
	case SandboxConnectionAccountNewParamsAuthenticationTypeAPIToken, SandboxConnectionAccountNewParamsAuthenticationTypeAssisted, SandboxConnectionAccountNewParamsAuthenticationTypeCredential, SandboxConnectionAccountNewParamsAuthenticationTypeOAuth:
		return true
	}
	return false
}
